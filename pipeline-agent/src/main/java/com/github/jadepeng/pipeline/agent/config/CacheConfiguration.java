...
//        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("agent");
//        if (hazelCastInstance != null) {
//            log.debug("Hazelcast already initialized");
//            return hazelCastInstance;
//        }
//        Config config = new Config();
//        config.setInstanceName("agent");
...
//        MapConfig mapConfig = new MapConfig("com.github.jadepeng.pipeline.agent.domain.*");
